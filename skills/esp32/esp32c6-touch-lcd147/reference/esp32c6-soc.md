...
> three are kept. The board carries the **QFN32** variant (ESP32-C6FH8) — where the
...
> **This project's board carries the ESP32-C6FH8** — QFN32, **8 MB** in-package flash,
> 22 GPIOs. (The non-touch ESP32-C6-LCD-1.47 is the 4 MB FH4 part; that is one of the
> several ways the two boards differ.) See [board-hardware.md](board-hardware.md).
