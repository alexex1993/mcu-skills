# Template — ESP32-WROOM-32 devkit (30-pin)
...
| `include/board.h` | **the only board-specific file** — 25 exposed GPIOs, no GPIO0, no flash pins | yes |
...
this header layout, the safe/input-only/strapping/flash pin lists, and the SPI pin
