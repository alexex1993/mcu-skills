#!/usr/bin/env bash
# Scaffold an Arduino Nano (ATmega328P) project from this template.
#
#   ./new-project.sh <target-dir> [--full|--minimal]
#
#   --full     (default) LED heartbeat + serial report + ADC + EEPROM + free-RAM
#   --minimal  classic Blink on LED_BUILTIN (D13), nothing else
#
