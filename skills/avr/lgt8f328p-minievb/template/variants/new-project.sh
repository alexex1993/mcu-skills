#!/usr/bin/env bash
# Scaffold an LGT8F328P-LQFP32 MiniEVB project from this template.
#
#   ./new-project.sh <target-dir> [--full|--minimal]
#
#   --full     (default) heartbeat + clock report + 12-bit ADC + VCC measurement
#              + DAC ramp on D4 + EEPROM boot counter + free-RAM watch
#   --minimal  Blink on LED_BUILTIN (D13), nothing else
#
